...
export class GetTransactionByHash extends Action {
  ...
  constructor() {
    ...
    this.description = "I return information about Avalanche Transaction by hash. EXAMPLE: 0x118e1747566adeaab6afede9de76ebeb5b10bb56ec510a099fb5a82221e9d0e7";
    this.outputExample = {};
    this.inputs = {
      hash: { required: true,  }
    };
...
export class GetXTransactionsAfterNthFromAddress extends Action {
    ...
    constructor() {
      ...
      this.description = "I return information about Avalanche X transactions after Nth transaction";
      this.outputExample = {};
      this.inputs = {
    ...
    async run({ params }) {
        ...
        if ((params.address).charAt(0) == X_CHAIN) {
          xChainTransactions = await xChain.getXTransactionsAfterNthFromAddressFromXChain(params.address, params.n, params.x);
          ...
          pChainTransactions = await pChain.getXTransactionsAfterNthFromAddressFromPChain(params.address, params.n, params.x);
          ...
          cChainTransactions = await cChain.getXTransactionsAfterNthFromAddressFromCChain(params.address, params.n, params.x);
...
export class GetXPendingTransactionsAfterNth extends Action {
    ...
    constructor() {
      ...
      this.description = "I return information about X Avalanche pending transactions after Nth transaction";
      this.outputExample = {};
      this.inputs = {
        n: { required: true },
        x: { required: true }
    ...
    if (params.n > 0 && params.x > 0) {
      cChainTransactions = await cChain.getXPendingTransactionsAfterNthFromCChain(params.n, params.x);
...
export class GetRecentTransactionsFromXChain extends Action {
    ...
    constructor() {
      ...
      this.description = "I return information about recent transactions from X chain";
      this.outputExample = {};
    }
...
export class GetRecentTransactionsFromPChain extends Action {
    ...
    constructor() {
      ...
      this.description = "I return information about recent transactions from P chain";
      this.outputExample = {};
